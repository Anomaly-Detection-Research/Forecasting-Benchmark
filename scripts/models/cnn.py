...
class cnn:
    def __init__(self, data, epochs, batch_size, training_ratio, sequance_length,CL1filters=1, CL1kernal_size=2, CL1strides=1, PL1pool_size=1, DL1units=20, DL2units=5, DL3units=1):
